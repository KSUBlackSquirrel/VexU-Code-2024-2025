...
DriveSubsystem driveSubsystem = DriveSubsystem();
ArmSubsystem armSubsystem = ArmSubsystem();
IntakeSubsystem intakeSubsystem = IntakeSubsystem();
ConveyorSubsystem conveyorSubsystem = ConveyorSubsystem();
ClampSubsystem clampSubsystem = ClampSubsystem();
