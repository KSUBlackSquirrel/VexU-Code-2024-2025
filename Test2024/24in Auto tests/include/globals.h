...
const static std::vector<std::int8_t> leftMotorsID = {-1,-16,-2};
...
const static std::int8_t intakeMotorID = 4;
...
const static std::int8_t conveyorMotorID = 3;
...
namespace globalArm {
    ...
    const static pros::MotorGears armColor = pros::MotorGearset::red;
